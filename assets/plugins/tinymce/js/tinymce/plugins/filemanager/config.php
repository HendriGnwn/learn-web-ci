...
$upload_dir = '/sisApp/assets/plugins/tinymce/source/'; // path from base_url to upload base dir
// $upload_dir = '/assets/plugins/tinymce/source/'; // path from base_url to upload base dir
