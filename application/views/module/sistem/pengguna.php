	...
	<div class="page-head">
		<div class="container">
			<div class="page-title">
				<h1>Data Pengguna <small>manajemen data pengguna</small></h1>
			</div>
		</div>
	</div>
	<div class="page-content">
		<div class="container">
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="#">Sistem</a><i class="fa fa-circle"></i>
				</li>
				<li class="active">
					 Data Pengguna
				</li>
											...
											<table class="table table-striped table-bordered table-hover" id="dataTables-example">
												...
												?>
													<tr class="odd gradeX">
														...
														<td style="text-align:center !important;">
															<a href="javascript:;" id="btn-edit" title="Edit" id_edit="<?php echo $data['id_user'];?>" class="label label-sm label-primary">
																<i class="fa fa-edit"></i> Edit 
															</a>&nbsp;
															<a href="javascript:;" id="btn-delete" title="Delete" id_delete="<?php echo $data['id_user'];?>" class="label label-sm label-danger">
								...
								<div class="col-md-12 col-sm-12">
									<div class="portlet light">
										...
										<div class="portlet-body form">
	    									<form action="<?php echo site_url('sistem/simpan_pengguna'); ?>" role="form" class="form-horizontal" method="POST" enctype="multipart/form-data" id="form-add">
												<div class="form-body">
							...
							<div class="row list-separated" id="edit" style="display:none;">
								<div class="col-md-12 col-sm-12">
									<div class="portlet light">
										...
										<div class="portlet-body form">
	    									<form action="<?php echo site_url('sistem/edit_pengguna'); ?>" role="form" class="form-horizontal" method="POST" enctype="multipart/form-data" id="form-edit">
...
<script src='<?php echo base_url();?>assets/js/page/js_pengguna.js'></script>