	...
	<div class="page-head">
		<div class="container">
			<div class="page-title">
				<h1>Data Kelas <small>manajemen data Kelas</small></h1>
			</div>
		</div>
	</div>
									...
									<div class="portlet light">
										<div class="portlet-title">
											<div class="caption">
												...
												<span class="caption-subject font-green-sharp bold uppercase">Data Kelas</span>
											</div>
											...
											<table class="table table-striped table-bordered table-hover" id="dataTables-example">
												...
												?>
													<tr class="odd gradeX">
														...
														<td style="text-align:center !important;">
															<a href="javascript:;" id="btn-edit" title="Edit" id_edit="<?php echo $data['id_kelas'];?>" class="label label-sm label-primary">
																<i class="fa fa-edit"></i> Edit 
															</a>&nbsp;
															<a href="javascript:;" id="btn-delete" title="Delete" id_delete="<?php echo $data['id_kelas'];?>" class="label label-sm label-danger">
								...
								<div class="col-md-12 col-sm-12">
									<div class="portlet light">
										...
										<div class="portlet-body form">
	    									<form action="<?php echo site_url('administrasi/simpan_kelas'); ?>" role="form" class="form-horizontal" method="POST" enctype="multipart/form-data" id="form-add">
												<div class="form-body">
							...
							<div class="row list-separated" id="edit" style="display:none;">
								<div class="col-md-12 col-sm-12">
									<div class="portlet light">
										...
										<div class="portlet-body form">
	    									<form action="<?php echo site_url('administrasi/edit_kelas'); ?>" role="form" class="form-horizontal" method="POST" enctype="multipart/form-data" id="form-edit">
...
<script src='<?php echo base_url();?>assets/js/page/js_kelas.js'></script>